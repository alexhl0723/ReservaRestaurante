<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <head>
        <title>Galería Equipo - Náutica Plus</title>
        ...
        <div class="flex flex-col md:flex-row min-h-screen">
            ...
            <main class="flex-1 p-8 md:p-12">
                ...
                <div class="relative mb-12">
                    ...
                    <div class="relative">
                        <h1 class="text-4xl font-bold text-gray-800 mb-2">Galería de Imágenes de Nuestro Equipo</h1>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    ...
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/equipo/equipo2.webp', 'Fotografía grupal de todo el equipo', '15 Julio 2015', '5.2 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/equipo/equipo2.webp" alt="equipo2"
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Fotografía grupal de todo el equipo</h3>
                    ...
                    <!-- Image Card 2 -->
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/equipo/equipo4.webp', 'El equipo sentados en una reunión', '10 Diciembre 2017', '3.8 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/equipo/equipo4.webp" alt="Imagen 2"
                                class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span
                                class="absolute top-4 right-4 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium shadow-md">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">El equipo sentados en una reunión</h3>
                            <div class="flex items-center text-sm text-gray-600">
                                <i class="fas fa-calendar-alt mr-2"></i>
                    ...
                    <!-- Image Card 3 -->
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/equipo/equipo6.webp', 'Dos miembros del equipo en el área de servicio', '12 Octubre 2019', '3.8 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/equipo/equipo6.webp" alt="Imagen 2"
                                class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span
                                class="absolute top-4 right-4 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium shadow-md">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Dos miembros del equipo en el área de servicio</h3>
                            <div class="flex items-center text-sm text-gray-600">
                                <i class="fas fa-calendar-alt mr-2"></i>
                    ...
                    <!-- Image Card 4 -->
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/equipo/equipo7.webp', 'Nuestra Chef sonriente con uniforme blanco', '10 Abril 2022', '3.8 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/equipo/equipo7.webp" alt="Imagen 2"
                                class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span
                                class="absolute top-4 right-4 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium shadow-md">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Nuestra Chef sonriente con uniforme blanco</h3>
                            <div class="flex items-center text-sm text-gray-600">
                                <i class="fas fa-calendar-alt mr-2"></i>
                    ...
                    <!-- Image Card 5 -->
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/equipo/equipo10.webp', 'Grupo reunido en el área de servicio', '10 Diciembre 2023', '3.8 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/equipo/equipo10.webp" alt="Imagen 2"
                                class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span
                                class="absolute top-4 right-4 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium shadow-md">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Grupo reunido en el área de servicio</h3>
                            <div class="flex items-center text-sm text-gray-600">
                                <i class="fas fa-calendar-alt mr-2"></i>
