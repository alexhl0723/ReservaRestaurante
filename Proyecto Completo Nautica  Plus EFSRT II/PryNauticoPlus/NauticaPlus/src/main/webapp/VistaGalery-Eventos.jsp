<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Galería Eventos - Náutica Plus</title>
...
@media (max-width: 768px) {
    * {
    ...
    <body class="bg-gray-100 relative overflow-x-hidden font-[Cinzel_Variable]">
        <div class="flex flex-col md:flex-row min-h-screen">
            ...
            <main class="flex-1 p-8 md:p-12">
                ...
                <div class="relative mb-12">
                    ...
                    <div class="relative">
                        <h1 class="text-4xl font-bold text-gray-800 mb-2">Galería de Imágenes de Nuestros Eventos</h1>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    ...
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/eventos/evento1.jpeg', 'Arreglo floral elegante con una tarjeta de bienvenida en un evento con vista al mar.', '12 Julio 2022', '5.2 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/eventos/evento1.jpeg" alt="Evento1"
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Arreglo floral elegante con una tarjeta de bienvenida en un evento con vista al mar.</h3>
                            <div class="flex items-center text-sm text-gray-600">
                                <i class="fas fa-calendar-alt mr-2"></i>
                                <span>12 Julio 2022</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Image Card 2 -->
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/eventos/evento2.jpeg', 'Espacio interior con iluminación tenue y ventanales arqueados que dejan entrar la luz natural.', '10 Diciembre 2013', '3.8 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/eventos/evento2.jpeg" alt="eventos 2"
                                class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span
                                class="absolute top-4 right-4 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium shadow-md">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Espacio interior con iluminación tenue y ventanales arqueados que dejan entrar la luz natural.</h3>
                            <div class="flex items-center text-sm text-gray-600">
                                <i class="fas fa-calendar-alt mr-2"></i>
                                <span>10 Diciembre 2013</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Image Card 3 -->
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/eventos/evento3.jpeg', 'Mesa decorada en un salón con techo de madera y lámparas colgantes doradas, con vista al océano.', '12 Octubre 2023', '3.8 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/eventos/evento3.jpeg" alt="evento 3"
                                class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span
                                class="absolute top-4 right-4 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium shadow-md">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Mesa decorada en un salón con techo de madera y lámparas colgantes doradas, con vista al océano.</h3>
                            <div class="flex items-center text-sm text-gray-600">
                                <i class="fas fa-calendar-alt mr-2"></i>
                    ...
                    <!-- Image Card 4 -->
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/eventos/evento4.jpeg', 'Marco con un mensaje decorativo sobre una mesa blanca, en un ambiente con detalles boho.', '10 Abril 2023', '3.8 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/eventos/evento4.jpeg" alt="evento 4"
                                class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span
                                class="absolute top-4 right-4 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium shadow-md">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Marco con un mensaje decorativo sobre una mesa blanca, en un ambiente con detalles boho.</h3>
                            <div class="flex items-center text-sm text-gray-600">
                                <i class="fas fa-calendar-alt mr-2"></i>
                    ...
                    <!-- Image Card 5 -->
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/eventos/evento5.jpg', 'Terraza con vista al mar, equipada con mesas y sillas altas para disfrutar del paisaje.', '12 Diciembre 2023', '3.8 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/eventos/evento5.jpg" alt="eventos 5"
                                class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span
                                class="absolute top-4 right-4 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium shadow-md">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Terraza con vista al mar, equipada con mesas y sillas altas para disfrutar del paisaje.</h3>
                            <div class="flex items-center text-sm text-gray-600">
                                <i class="fas fa-calendar-alt mr-2"></i>
            ...
            <!-- Image Card 6 -->
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/eventos/evento6.jpg', 'Área lounge con sofás y decoración bohemia en un espacio abierto con vista panorámica al océano.', '12 Septiembre 2023', '3.8 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/eventos/evento6.jpg" alt="eventos 6"
                                class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span
                                class="absolute top-4 right-4 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium shadow-md">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Área lounge con sofás y decoración bohemia en un espacio abierto con vista panorámica al océano.</h3>
                            <div class="flex items-center text-sm text-gray-600">
                                <i class="fas fa-calendar-alt mr-2"></i>
