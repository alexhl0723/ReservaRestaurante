<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Galería Sabores - Náutica Plus</title>
        ...
        <div class="flex flex-col md:flex-row min-h-screen">
            ...
            <main class="flex-1 p-8 md:p-12">
                ...
                <div class="relative mb-12">
                    ...
                    <div class="relative">
                        <h1 class="text-4xl font-bold text-gray-800 mb-2">Galería de Imágenes de Nuestros Sabores</h1>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    ...
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/sabores/sabores (1).webp', 'Plato de pasta con una salsa cremosa y un toque de queso, acompañado de una copa de vino blanco.', '15 Julio 2023', '5.2 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/sabores/sabores (1).webp" alt="Sabores1"
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Plato de pasta con una salsa cremosa y un toque de queso, acompañado de una copa de vino blanco.</h3>
                    ...
                    <!-- Image Card 2 -->
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/sabores/sabores (2).webp', 'Mariscos siendo flameados en una parrilla, creando un efecto visual impresionante.', '10 Diciembre 2023', '3.8 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/sabores/sabores (2).webp" alt="sabores 2"
                                class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span
                                class="absolute top-4 right-4 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium shadow-md">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Mariscos siendo flameados en una parrilla, creando un efecto visual impresionante.</h3>
                            <div class="flex items-center text-sm text-gray-600">
                                <i class="fas fa-calendar-alt mr-2"></i>
                    ...
                    <!-- Image Card 3 -->
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/sabores/sabores (3).webp', 'Manos sirviendo ostras gratinadas con queso y pan rallado.', '12 Octubre 2023', '3.8 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/sabores/sabores (3).webp" alt="sabores 3"
                                class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span
                                class="absolute top-4 right-4 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium shadow-md">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Manos sirviendo ostras gratinadas con queso y pan rallado.</h3>
                            <div class="flex items-center text-sm text-gray-600">
                                <i class="fas fa-calendar-alt mr-2"></i>
                    ...
                    <!-- Image Card 4 -->
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/sabores/sabores (4).webp', 'Pierna de cordero asada con papas doradas y espinacas, acompañada de un jugo natural.', '10 Abril 2023', '3.8 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/sabores/sabores (4).webp" alt="sabores 4"
                                class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span
                                class="absolute top-4 right-4 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium shadow-md">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Pierna de cordero asada con papas doradas y espinacas, acompañada de un jugo natural.</h3>
                            <div class="flex items-center text-sm text-gray-600">
                                <i class="fas fa-calendar-alt mr-2"></i>
                    ...
                    <!-- Image Card 5 -->
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/sabores/sabores (5).webp', 'Lomo saltado con papas y arroz, acompañado de una bebida refrescante.', '12 Diciembre 2023', '3.8 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/sabores/sabores (5).webp" alt="sabores 5"
                                class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span
                                class="absolute top-4 right-4 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium shadow-md">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Lomo saltado con papas y arroz, acompañado de una bebida refrescante.</h3>
                            <div class="flex items-center text-sm text-gray-600">
                                <i class="fas fa-calendar-alt mr-2"></i>
            ...
            <!-- Image Card 6 -->
                    <div class="group relative bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 cursor-pointer overflow-hidden"
                        onclick="openModal('./public/categoriasGalery/sabores/sabores (6).webp', 'Copa de postre con fresas y crema, ideal como un final dulce.', '12 Septiembre 2023', '3.8 MB')">
                        <div class="relative aspect-video overflow-hidden">
                            <img src="./public/categoriasGalery/sabores/sabores (6).webp" alt="sabores 6"
                                class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                            <span
                                class="absolute top-4 right-4 bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-medium shadow-md">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">Copa de postre con fresas y crema, ideal como un final dulce.</h3>
                            <div class="flex items-center text-sm text-gray-600">
                                <i class="fas fa-calendar-alt mr-2"></i>
